...
def combined_diff(
    ...
    for group in diff.get_grouped_opcodes(context_size):
        ...
        # We could get a diff group that has no addresses for one of the lists.
        # This probably won't happen, but it could occur if there is a block of
        # non-code data. In that case, show the best slug line that we can.
